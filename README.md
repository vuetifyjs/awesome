...
- [Marvel Heroes showcase](https://github.com/rupamkairi/Marvel-Heroes) - A fully responsive application consumes marvel api to create a showcase, made with Vue + Vuetify + Vuex.
