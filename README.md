...
- [Learn how to setup and use Storybook with Vuetify the proper way](https://github.com/nidkil/vuetify-with-storyboard) - You have the choice to follow along and configure your project yourself and really understand how it works or just clone and use the repository. The choice is yours. Are you going to choose the red pill or the blue pill?
