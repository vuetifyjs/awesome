...
- [Marvel Herocase](https://github.com/rupamkairi/marvel-heroes) - A fully responsive application consumes marvel api to create a showcase, made with Vue + Vuetify + Vuex.
